...
public class WelcomeActivity extends AppCompatActivity {
    private static final String TAG = "TLC WELCOME ACTIVITY";
    private static final String APP_KEY = "6caj23cwnpc7bd0";
    private static final String APP_SECRET = "o637eksxojcu85j";
